...
Page({
  ...
  data: {
    ...
    address:[{
      ...
      name:'欧阳',
      phnoe:'13890909090',
      address:"四川省成都市武侯区桂溪街道青年公寓3栋1018"
    }],
  shopcarid:"",
    num: 1,
    minusStatus: 'disable',
  ...
  postorder:function(e){
    ...
    wx.showModal({
      ...
      success: function (res) { 
        params.push({ 'shopcarid': that.data.shopcarid,'price':price})
        app.globalData.orderlist = params;
  ...
  onLoad: function (options) {
    var that=this;
    var newshopcar=[];
    this.setData({ shopcarid: decodeURIComponent(options.shopcarid)})
    ...
    that.setData({ messge: newshopcar })
  },
